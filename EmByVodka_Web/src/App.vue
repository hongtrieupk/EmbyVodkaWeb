	...
	<main>
		...
		<div class="main-content">
				...
				<div class="container">
					<div class="ttcmsaboutus ttabout d-lg-flex d-md-flex d-sm-flex d-xs-block align-items-center">
						...
						<div class="ttcmsabout-desc col-sm-6 col-xs-12 float-left right-to-left hb-animate-element">
							<div class="ttabout-title text-capitalize font-italic mb-30 position-relative">Women's
								Fashion</div>
							<div class="ttabout-subtitle text-uppercase position-relative mb-30">Get Started with Decor.
							</div>
			...
			<div id="main">
										...
										<div class="ttbestseller-content products grid owl-carousel" id="owl3">
											...
											<div class="product-layouts">
												<div class="product-thumb">
													<div class="image vertical_scrolling_bottom_to_top">
														<a href="product-details.html">
															<img src="./assets/img/products/06.jpg" alt="03" /> </a>
													</div>
													<div class="thumb-description">
														<div class="caption">
															<h4 class="product-title text-capitalize"><a
											...
											<div class="product-layouts">
												<div class="product-thumb">
													<div class="image vertical_scrolling_bottom_to_top">
														<a href="product-details.html">
															<img src="./assets/img/products/07.jpg" alt="03" /> </a>
													</div>
													<div class="thumb-description">
														<div class="caption">
															<h4 class="product-title text-capitalize"><a
											...
											<div class="product-layouts">
												<div class="product-thumb">
													<div class="image vertical_scrolling_bottom_to_top">
														<a href="product-details.html">
															<img src="./assets/img/products/08.jpg" alt="03" /> </a>
													</div>
													<div class="thumb-description">
														<div class="caption">
															<h4 class="product-title text-capitalize"><a
				...
				<div id="ttcmstestimonial" class="my-40 my-sm-25 bottom-to-top hb-animate-element style2">
								...
								<li>
									<div class="testimonial-block d-lg-flex d-md-flex d-sm-block align-items-center">
										<div class="ttimage col-sm-3 float-left">
											<div class="testimonial-image float-left d-flex align-items-center"><img alt=""
													src="./assets/img/banner/user1.jpg" />
				...
				<div id="ttcmsparallax"
					class="ttcmsparallax my-40 my-sm-25 bottom-to-top hb-animate-element float-left w-100">
					<div class="parallax float-left w-100">
				...
				<div id="ttlookbook" class="ttlook my-40 bottom-to-top hb-animate-element float-left w-100">
					<div class="container">
						<div class="row">
							<div class="ttlookbook-content products grid owl-carousel">
								<div class="product-layouts">
									<div class="product-thumb">
										<div class="image vertical_scrolling_bottom_to_top col-sm-6 float-right">
											<div class="inner-img">
												<div class="image">
													<a href="#">
														<img src="./assets/img/products/01.jpg" alt="01" />
												...
												<div class="image">
													<a href="#">
														<img src="./assets/img/products/02.jpg" alt="01" />
														<img src="./assets/img/products/03.jpg" alt="02"
															class="second_image img-responsive" />
													</a>
												</div>
												<div class="image">
													<a href="#">
														<img src="./assets/img/products/04.jpg" alt="01" />
														<img src="./assets/img/products/05.jpg" alt="02"
															class="second_image img-responsive" />
													</a>
												</div>
												<div class="image">
													<a href="#">
														<img src="./assets/img/products/06.jpg" alt="01" />
														<img src="./assets/img/products/07.jpg" alt="02"
															class="second_image img-responsive" />
													</a>
												</div>
											</div>
										...
										<div class="thumb-description col-sm-6">
											<div class="caption mb-20">
												<h4 class="product-title text-capitalize"><a href="product-details.html"
														class="position-relative">aliquam quaerat voluptatem</a></h4>
											</div>
											...
											<div class="category-description">Lorem ipsum dolor sit amet, consectetur
												adipiscing elit. Nam sagittis, magna et euismod auctor, mauris ipsum
												interdum risus, a varius augue lacus id diam. Mauris maximus, ipsum at
												gravida sodales, purus tellus tempor eros, a feugiat elit odio in nunc.
											</div>
					...
					<div id="ttsmartblog" class="my-40 my-sm-25 bottom-to-top hb-animate-element">
						...
						<div class="container">
							<div class="row">
								<div class="smartblog-content owl-carousel text-center">
									<div class="blog-inner">
										<div class="ttblog">
											<div class="item">
												<div class="ttblog_image_holder">
													<a href="#">
														<img src="./assets/img/banner/blog-01.jpg" alt="blog-01"> </a>
										...
										<div class="ttblog">
											<div class="item">
												<div class="ttblog_image_holder">
													<a href="#">
														<img src="./assets/img/banner/blog-02.jpg" alt="blog-02"> </a>
													<span class="blogicons">
										...
										<div class="ttblog">
											<div class="item">
												<div class="ttblog_image_holder">
													<a href="#">
														<img src="./assets/img/banner/blog-03.jpg" alt="blog-03"> </a>
													<span class="blogicons">
												...
												<div class="blog-content-wrap float-left w-100">
													<div class="blog_inner">
														<h4 class="blog-title"><span>From Now we are certified
																web</span></h4>
														<div class="blog-desc">Lorem ipsum dolor sit amet, consectetur
															adipiscing elit.</div>
														<div class="read-more text-capitalize">
									...
									<div class="blog-inner">
										<div class="ttblog">
											<div class="item">
												<div class="ttblog_image_holder">
													<a href="#">
														<img src="./assets/img/banner/blog-04.jpg" alt="blog-04"> </a>
													<span class="blogicons">
												...
												<div class="blog-content-wrap float-left w-100">
													<div class="blog_inner">
														<h4 class="blog-title"><span>Viderer voluptatum te eum</span>
														</h4>
														<div class="blog-desc">Lorem ipsum dolor sit amet, consectetur
															adipiscing elit.</div>
														<div class="read-more text-capitalize">
										...
										<div class="ttblog">
											<div class="item">
												<div class="ttblog_image_holder">
													<a href="#">
														<img src="./assets/img/banner/blog-05.jpg" alt="blog-05"> </a>
													<span class="blogicons">
					...
					<div id="ttbrandlogo" class="my-40 my-sm-25 bottom-to-top hb-animate-element">
						<div class="container">
							<div class="tt-brand owl-carousel">
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-01.png" alt="brand-logo-01"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-02.png" alt="brand-logo-02"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-03.png" alt="brand-logo-03"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-04.png" alt="brand-logo-04"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-05.png" alt="brand-logo-05"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-06.png" alt="brand-logo-06"></a>
								</div>
								<div class="item">
									<a href="#"><img src="./assets/img/logos/brand-logo-07.png" alt="brand-logo-07"></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="ttcmsservices owl-carousel">
					<div class="ttservice col-sm-4 d-md-flex align-items-center">
						...
						<div class="service-content text-md-left">
							<div class="service-title">Free Shipping item</div>
					...
					<div class="ttservice col-sm-4 d-md-flex align-items-center">
						<div class="icon">
							<div class="ttshipping_img service-icon"><img src="./assets/img/logos/icon3_small.png"
									alt="icon3_small" /></div>
						</div>
						<div class="service-content text-md-left">

                ...
                <div class="container">
                    <div class="row align-items-center about-main">
                        <div class="col-12 col-lg-5 text-center col-left">
                            <img src="../../../assets/img/banner/about-us.jpg" alt="" class="border-radius-6 w-100"
                                data-no-retina="">
                        </div>
                        <div class="col-12 col-lg-7 col-right">
                            <span class="d-inline-block title mb-10">Don’t worry, you’re in safe hands.</span>
                            <h6 class="d-inline-block desc mb-30 font-weight-bold">We are committed to our customers’
                                success from start to finish. Our input helps make their solutions.</h6>
                            <p class="m-0 sub-desc ">Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry. Lorem Ipsum has been the industry's standard dummy text ever since. Lorem Ipsum
                                has been the industry's standard dummy text ever since. Lorem Ipsum is printing and
                                typesetting simply dummy text.</p>
            ...
            <div id="about-main-2" class="float-left w-100 mb-150 mb-sm-30">
                <div class="d-flex d-lg-flex d-sm-block d-xs-block align-items-center about-main-2 bg-light">
                    <div class="col-12 col-lg-6 col-right px-100">
                        ...
                        <div class="row text-center text-md-left">
                            ...
                            <div class="col-12 col-xl-6 col-lg-12 col-md-6 mb-30">
                                ...
                                <p class="desc">Lorem Ipsum is simply text the printing and typesetting standard industry.
                    ...
                    <div class="col-12 col-lg-6 text-center col-left p-0">
                        <img src="../../../assets/img/banner/about-us1.jpg" alt="" class="border-radius-6 w-100"
                            data-no-retina="">
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="about-us-team">
                        <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                            <div class="team-block-inner position-relative">
                                <div class="team-image text-center">
                                    <img src="../../../assets/img/banner/team-01.jpg" alt="team-01" />
                                ...
                                <div class="team-content text-center float-left w-100">
                                    ...
                                    <div class="social-sharing float-left w-100">
                                        <ul class="d-flex justify-content-center">
                                            <li class="facebook">
                                                <a  target="_blank" class="facebook_link">
                                            ...
                                            <li class="twitter">
                                                <a  target="_blank" class="twitter_link">
                                                    <svg class="svg-icon" viewBox="0 0 20 20" width="18px" height="18px">
                                                        <path fill="#666"
                                            ...
                                            <li class="google">
                                                <a  target="_blank" class="google_link">
                                                    <svg class="svg-icon" viewBox="0 0 20 20" width="18px" height="18px">
                                                        <path fill="#666"
                                            ...
                                            <li class="pinterest">
                                                <a  target="_blank" class="pinterest_link">
                                                    <svg class="svg-icon" viewBox="0 0 20 20" width="18px" height="18px">
                                                        <path fill="#666"
                        ...
                        <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                            <div class="team-block-inner position-relative">
                                <div class="team-image text-center">
                                    <img src="../../../assets/img/banner/team-02.jpg" alt="team-02" />
                                    <div class="overlay"></div>
                                </div>
                                <div class="team-content text-center float-left w-100">
                                    <div class="team-name text-capitalize font-weight-bold">john duff</div>
                        ...
                        <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                            <div class="team-block-inner position-relative">
                                <div class="team-image text-center">
                                    <img src="../../../assets/img/banner/team-03.jpg" alt="team-03" />
                                    <div class="overlay"></div>
                                </div>
                                <div class="team-content text-center float-left w-100">
                                    <div class="team-name text-capitalize font-weight-bold">john duff</div>
                        ...
                        <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                            <div class="team-block-inner position-relative">
                                <div class="team-image text-center">
                                    <img src="../../../assets/img/banner/team-04.jpg" alt="team-04" />
                                    <div class="overlay"></div>
                                </div>
                                <div class="team-content text-center float-left w-100">
                                    <div class="team-name text-capitalize font-weight-bold">john duff</div>
            ...
            <div id="ttbrandlogo" class="my-40 my-sm-25 bottom-to-top hb-animate-element py-100 mb-150 py-sm-20 mb-sm-30">
                <div class="container">
                    <div class="tt-brand owl-carousel">
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-01.png" alt="brand-logo-01"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-02.png" alt="brand-logo-02"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-03.png" alt="brand-logo-03"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-04.png" alt="brand-logo-04"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-05.png" alt="brand-logo-05"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-06.png" alt="brand-logo-06"></a>
                        </div>
                        <div class="item">
                            <a ><img src="../../../assets/img/logos/brand-logo-07.png" alt="brand-logo-07"></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="testimonial-block">
                                    ...
                                    <div class="testimonial-content">
                                        <div class="testimonial-desc">
                                            ...
                                            <p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam
                                                mattis arcu convallis, bibendum dui ac, laoreet est.Vivamus interdum egastas
                                                rutrum. Quisque laoreet ante sed placerat imperdiet.
                                            </p>
                                        </div>

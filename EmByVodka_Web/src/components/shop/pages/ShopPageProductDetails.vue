            ...
            <div class="row">
                <div class="left-columm col-lg-5 col-md-5">
                    <div class="product-large-image tab-content">
                        <div class="tab-pane" role="tabpanel" v-for="(imgUrl, index) in product.imageUrls" :key="index"
                            :id="'product-' + index" :aria-labelledby="'product-tab-' + index"
                            :class="{ active: index === 0 }">
                            <div class="single-img img-full">
                                <a><img :src="imgUrl" class="img-fluid zoomImg" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="default small-image-list float-left w-100">
                        <div class="nav-add small-image-slider-single-product-tabstyle-3 owl-carousel" role="tablist">
                            <div class="single-small-image img-full" v-for="(imgUrl, index) in product.imageUrls"
                                :key="index">
                                <a data-toggle="tab" :id="'product-tab-' + index" :href="'#product-' + index"
                ...
                <div class="right-columm col-lg-7 col-md-7">
                    <div class="product-information">
                        <h4 class="product-title text-capitalize float-left w-100">
                            <a class="float-left w-100">{{ product.name }}</a>
                        </h4>
                        ...
                        <div class="rating">
                            ...
                            <a class="review-down">(customer reviews)</a>
                        </div>
